...
3. **Rating Criteria (Informational):** Plain-English summary of what VA measures for this condition and what symptom thresholds drive each rating level. *Educational context only — not a rating prediction.*

4. **Effective Date:** Earliest supportable date based on available evidence. Flag if earlier evidence may exist.

5. **Risks:** Any language in the records that could be used against this claim — with a plain-English explanation of why it matters and what to do about it.
...
## 10. Summary Output — Strategy Document

At the end of every full analysis, generate a summary using the structure below. This document can be shared with a VSO, attorney, or doctor.
...
Group secondary claims by body system (cardiovascular, respiratory, GI, musculoskeletal, etc.). Within each group, list conditions in order of projected rating impact — highest first.

For each condition:
- **Condition:** [Name]
- **Theory:** [What it is connected to and why — one sentence]
- **Rationale:** [Plain-English explanation of the link]
- **Claim Strength:** Strong / Moderate / Developing
- **Rating Criteria (Informational):** What VA measures for this condition and what symptom thresholds drive each rating level. *Educational context — not a rating prediction.*
- **Secondary Connection:** Plain-English explanation written to help a physician understand the link.

---

**Section III — Expansion Opportunities**
Documented conditions not yet filed. Note what is needed to develop each into a claim.

---

**Section IV — Next Steps**
Prioritized action list in filing-priority order. For each: what to do, why it matters, and who does it.

---

**Evidence Gaps**
Missing pieces that could prevent a claim from advancing:
- ⚠️ No nexus letter
- ⚠️ Unconfirmed diagnosis
- ⚠️ No buddy statement
- ⚠️ Treatment gap (2+ years no documented care)
- ⚠️ Functional loss not documented

---

**Doctor Conversation Guidance**

The goal is informed dialogue — not document delivery. Present the identified connection, ask the doctor to evaluate it on its merits, and if they agree, ask them to document it naturally in your chart. Do not present pre-written nexus letters to sign. Do not use legal language unprompted. Let the doctor use their own clinical words.

---

**Supporting Documents Appendix**
List of records used in this analysis — no inline footnotes.

---

**Manual Input Transparency Notice**

> ⚠️ This summary may include conditions provided by the veteran that have not been confirmed by a medical provider or found in uploaded records. VACS analysis does not constitute a medical diagnosis or legal nexus opinion. Always review with a VSO, accredited claims agent, or VA-accredited attorney before filing.
